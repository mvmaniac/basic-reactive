...
public class SampleData {
  ...
  public static final List<Integer> salesOfBranchA = Arrays.asList(
      15_000_000, 25_000_000, 10_000_000, 35_000_000, 23_000_000, 40_000_000, 50_000_000,
      45_000_000, 35_000_000, 23_000_000, 15_000_000, 10_000_000
  );

  // 지점 B의 월별 매출
  public static final List<Integer> salesOfBranchB = Arrays.asList(
      11_000_000, 23_000_000, 15_000_000, 32_000_000, 13_000_000, 45_000_000, 55_000_000,
      43_000_000, 25_000_000, 28_000_000, 19_000_000, 13_000_000
  );

  // 지점 C의 월별 매출
  public static final List<Integer> salesOfBranchC = Arrays.asList(
      12_000_000, 21_000_000, 19_000_000, 33_000_000, 33_000_000, 41_000_000, 52_000_000,
      48_000_000, 32_000_000, 21_000_000, 18_000_000, 14_000_000
  );


  // 서울의 시간별 미세먼지 농도
  public static final List<Integer> seoulPM10List = Arrays.asList(
      45, 30, 68, 70, 100, 110, 120, 90, 80, 60, 50, 60, 70, 80, 100, 150, 140, 130, 170, 130, 90,
      86, 67, 50
  );

  // 부산의 시간별 미세먼지 농도
  public static final List<Integer> busanPM10List = Arrays.asList(
      35, 30, 63, 50, 80, 90, 100, 80, 70, 50, 55, 60, 65, 75, 80, 90, 100, 90, 120, 110, 70, 66,
      65, 55
  );

  // 인천의 시간별 미세먼지 농도
  public static final List<Integer> incheonPM10List = Arrays.asList(
      55, 40, 73, 70, 85, 99, 120, 85, 75, 73, 80, 70, 95, 95, 100, 120, 110, 120, 140, 120, 100,
      125, 135, 125
  );
  ...
  public static Observable<String> getSpeedPerSection(String section, long interval,
      final Integer[] speedData) {
