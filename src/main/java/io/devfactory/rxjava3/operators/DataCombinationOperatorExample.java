...
public class DataCombinationOperatorExample {
  ...
  public static void main(String[] args) {
    ...
    Observable.concat(observable7, observable6)
        .subscribe(data -> Logger.log(ON_NEXT, data));
    ...
    Observable<Long> observable8 =
        Observable.interval(200L, TimeUnit.MILLISECONDS)
            .take(4);

    Observable<Long> observable9 =
        Observable.interval(400L, TimeUnit.MILLISECONDS)
            .take(6);

    Observable.zip(observable8, observable9, Long::sum)
        .subscribe(data -> Logger.log(ON_NEXT, data));

    TimeUtil.sleep(3000L);

    Observable<Integer> observable10 = Observable.fromIterable(SampleData.seoulPM10List);
    Observable<Integer> observable11 = Observable.fromIterable(SampleData.busanPM10List);
    Observable<Integer> observable12 = Observable.fromIterable(SampleData.incheonPM10List);

    Observable<Integer> observable13 = Observable.range(1, 24);

    Observable.zip(observable10, observable11, observable12, observable13,
    ...
    Observable.combineLatest(observable14, observable15,
    ...
    // 랜덤 온도 데이터
    Observable<Integer> observable16 = Observable
    ...
    // 랜덤 습도 데이터
    Observable<Integer> observable17 = Observable
        .interval(NumberUtil.randomRange(100, 500), TimeUnit.MILLISECONDS)
        .take(10)
        .map(notUse -> SampleData.humidityOfSeoul[NumberUtil.randomRange(0, 5)]);

    Observable.combineLatest(observable16, observable17,
